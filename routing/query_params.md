...
> The key difference between query parameters and [route parameters](routeparams.md) is that route parameters are essential to determining route, whereas query parameters are optional.
...
Similar to reading [route parameters](routeparams.md), the `Router` service returns an [Observable](../observables/) we can subscribe to to read the query parameters:
