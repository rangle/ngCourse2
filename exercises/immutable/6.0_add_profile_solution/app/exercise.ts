...
const profile = fromJS({
  "_id": "5758bc3b6d9c7246a385cdd7",
  "index": 0,
  "guid": "3fdbf7c0-ac4a-4e56-b019-c0ace1565874",
  "isActive": true,
  "balance": "$3,960.12",
  "picture": "http://placehold.it/32x32",
  "age": 38,
  ...
  "gender": "male",
  "company": "FOSSIEL",
  "email": "grossfry@fossiel.com",
  "phone": "+1 (918) 502-3698",
  "address": "554 Kingsway Place, Salvo, Illinois, 2740",
  "about": "Et ullamco officia exercitation minim nisi laborum nulla aliquip esse deserunt. Lorem proident aliqua do minim Lorem nulla tempor. Deserunt cupidatat eiusmod minim aliquip incididunt amet. Veniam tempor amet tempor proident ea cupidatat culpa anim velit et. Excepteur qui do sunt commodo proident aute culpa eiusmod amet ut.\r\n",
  "registered": "2015-05-09T03:07:09 +04:00",
  "latitude": -25.645326,
  "longitude": 4.102847,
  "tags": [
    "sunt",
  ...
  "friends": [
    ...
    {
      "id": 2,
      "name": "Walton Mitchell"
    }
  ],
  "greeting": "Hello, Gross Fry! You have 9 unread messages.",
  "favoriteFruit": "strawberry"
});

const result = data.push(profile);
