...
If you checkout the branch `workshop-1`.
...
The `Tasks Reducer` has been setup with an initial state and some hard-coded tasks for us to work with. For the first part of this workshop, we will be dealing with redux actions in a synchronous way.
