...
[This interactive example][plunkInjectorTree] consists of a simple class called
`Unique` that generates a unique id each time its constructor is run.  The 
example describes some children components, and illustrates which componets use
which injector.
